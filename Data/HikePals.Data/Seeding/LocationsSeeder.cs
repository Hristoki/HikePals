namespace HikePals.Data.Seeding
{
    ...
    public class LocationsSeeder : ISeeder
    {
        ...
        public async Task SeedAsync(ApplicationDbContext dbContext, IServiceProvider serviceProvider)
        {
            ...
            await dbContext.Locations.AddAsync(new Location { Name = "Malyovitsa", Category = GetCategory(dbContext, "Summit"), CityId = GetCity(dbContext, "Samokov"), });

            await dbContext.Locations.AddAsync(new Location { Name = "Assen's Fortress", Category = GetCategory(dbContext, "Fortress"), CityId = GetCity(dbContext, "Asenovgrad"), });

            await dbContext.Locations.AddAsync(new Location { Name = "Raisko praskalo", Category = GetCategory(dbContext, "Waterfall"), CityId = GetCity(dbContext, "Kalofer"), });
            ...
            await dbContext.Locations.AddAsync(new Location { Name = "Byala reka", Category = GetCategory(dbContext, "Eco trail"), CityId = GetCity(dbContext, "Karlovo"), });
        }
